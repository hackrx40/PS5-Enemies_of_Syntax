...
class _IntroductionPageState extends State<IntroductionPage> {
  ...
  Future<void> addData() async {
    try {
      print("hello");
      String url = 'https://hackrx4prod-r677breg7a-uc.a.run.app/api/accounts/profile/';
      ...
      child: Scaffold(
        body: IntroductionScreen(
            onChange: (value) async {
              if (value == 1) {
                // Uri uri = Uri.parse('https://hackrx4prod-r677breg7a-uc.a.run.app/api/accounts/profile/');
                ...
                Uri uri = Uri.parse('https://hackrx4prod-r677breg7a-uc.a.run.app/api/bank/account/');
